...
const navGroups: NavGroup[] = [
  ...
  { label: "Deliverability", items: [
    { href: "/inbox-tests", label: "Inbox placement", icon: MailCheck },
    ...
    { href: "/unsubscribers", label: "Unsubscribers", icon: UserMinus },

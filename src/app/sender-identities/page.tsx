        ...
        {rows.length ? rows.map((row) => (
          <article key={row.id} className="premium-panel p-4">
            ...
            <div className="mt-3.5 grid grid-cols-3 gap-2">
              <div className="panel-soft p-2.5"><p className="text-[10px] font-black uppercase tracking-[.1em] text-[var(--muted)]">Transport</p><p className="mt-1 text-sm font-extrabold capitalize">{row.transportType}</p></div>

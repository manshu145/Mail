...
export default async function ReportsPage(){
  ...
  const cards=[{l:"Recipients",v:total,icon:Users,tone:"violet"},{l:"Remote MX accepted",v:delivered,icon:MailCheck,tone:"emerald"},{l:"Verified opens",v:opens,icon:BarChart3,tone:"blue"},{l:"Verified clicks",v:clicks,icon:MousePointerClick,tone:"cyan"}];
  ...
  return <AppShell session={session}>
    <div className="mb-7 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between"><div><p className="mb-2 text-xs font-extrabold uppercase tracking-[.18em] text-zinc-400">Analytics</p><h1 className="text-3xl font-black tracking-[-.035em] sm:text-4xl">Reports</h1><p className="mt-2 max-w-3xl text-sm leading-6 text-zinc-500">Delivery, provider health, verified engagement and recipient-level transport truth. Known automated scanners/previews remain separated from human activity.</p></div><LiveRefresh intervalMs={10000} label="Live metrics"/></div>

...
export default async function ReportsPage(){
  ...
  const cards=[{l:"Recipients",v:total,icon:Users},{l:"Remote MX accepted",v:delivered,icon:MailCheck},{l:"Verified opens",v:opens,icon:BarChart3},{l:"Verified clicks",v:clicks,icon:MousePointerClick}];

...
export default async function ValidationPage() {
  ...
  let jobs: typeof validationJobs.$inferSelect[] = []; let gmail = 0; let accepted = 0; let valid = 0; let invalid = 0; let unknown = 0; let dbError = false;
  if (databaseConfigured) { try { const [jobRows, gmailRows, acceptedRows, validRows, invalidRows, unknownRows] = await Promise.all([

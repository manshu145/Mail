...
export default async function ValidationPage() {
  ...
  return <AppShell session={session}>
    <div className="page-intro"><div><p className="page-eyebrow mb-1.5">Deliverability</p><h1 className="page-title">Gmail validation</h1><p className="page-description">Optional Gmail/Googlemail validation via Supersend. Campaign sending remains independent from this workflow.</p></div></div>

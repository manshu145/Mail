...
export default async function SegmentsPage() {
  ...
  return <AppShell session={session}>
    <div className="mb-7 flex flex-col gap-5 sm:flex-row sm:items-end sm:justify-between"><div><p className="page-eyebrow mb-2">Audience intelligence</p><h1 className="page-title">Segments</h1><p className="page-description">Build reusable audiences from contact data or real campaign engagement.</p></div><div className="flex flex-wrap gap-2"><EngagementSegmentCreate campaigns={campaignRows} disabled={!usable}/><SegmentCreate disabled={!usable}/></div></div>
